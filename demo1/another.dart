...
class SecondView1 extends StatefulWidget {
...
class _State extends State {
  ...
  @override
  Widget build(BuildContext context) {
    print(' SecondView Buildcontext '+global.text);
  ...
  void initState() {
    super.initState();
    print('hi there initState second'+global.text);
      ...
      setState(() {
        if (_counter >= 0) {
          ...
          if (_counter % global.totalTime == 0) {
            print('incrementing in SecondView '+global.text);
            stopaudio = 1;
